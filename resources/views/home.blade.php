                                            ...
                                            <div class="gc_filter_cont_overlay_wrapper">
                                                ...
                                                <div class="tab_image_text">
                                                    <div class="project_title">
                                                        <h4><a href="{{route('Products')}}"> Creative Web Design</a></h4>
                                                    </div>
                                                    <div class="project_category">
                                                        <h4><a href="{{route('Products')}}">Web Design</a></h4>
                                                    </div>
                                                    <div class="project_likes">
                                                        <a href="{{route('Products')}}"><i class="fa fa-heart-o" aria-hidden="true"></i> 1548</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 portfolio-wrapper III_column" data-groups='["all", "web_design", "elements", "UI_items"]'>
                                        <div class="portfolio-thumb">
                                            <div class="gc_filter_cont_overlay_wrapper">
                                                ...
                                                <div class="tab_image_text">
                                                    <div class="project_title">
                                                        <h4><a href="{{route('Products')}}">Complex Deshboard</a></h4>
                                                    </div>
                                                    <div class="project_category">
                                                        <h4><a href="{{route('Products')}}">Web Development</a></h4>
                                                    </div>
                                                    <div class="project_likes">
                                                        <a href="{{route('Products')}}"><i class="fa fa-heart-o" aria-hidden="true"></i> 1548</a>
                                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 portfolio-wrapper III_column" data-groups='["all", "photos", "social"]'>
                                        <div class="portfolio-thumb">
                                            <div class="gc_filter_cont_overlay_wrapper">
                                                ...
                                                <div class="tab_image_text">
                                                    <div class="project_title">
                                                        <h4><a href="{{route('Products')}}"> Digital Agency</a></h4>
                                                    </div>
                                                    <div class="project_category">
                                                        <h4><a href="{{route('Products')}}">Photos</a></h4>
                                                    </div>
                                                    <div class="project_likes">
                                                        <a href="{{route('Products')}}"><i class="fa fa-heart-o" aria-hidden="true"></i> 1548</a>
                                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 portfolio-wrapper III_column" data-groups='["all", "web_design", "photos", "social"]'>
                                        <div class="portfolio-thumb">
                                            <div class="gc_filter_cont_overlay_wrapper">
                                                ...
                                                <div class="tab_image_text">
                                                    <div class="project_title">
                                                        <h4><a href="{{route('Products')}}">Logo & Branding</a></h4>
                                                    </div>
                                                    <div class="project_category">
                                                        <h4><a href="{{route('Products')}}">UI Design</a></h4>
                                                    </div>
                                                    <div class="project_likes">
                                                        <a href="{{route('Products')}}"><i class="fa fa-heart-o" aria-hidden="true"></i> 1548</a>
                                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 portfolio-wrapper III_column" data-groups='["all", "UI_items", "elements", "elements"]'>
                                        <div class="portfolio-thumb">
                                            <div class="gc_filter_cont_overlay_wrapper">
                                                ...
                                                <div class="tab_image_text">
                                                    <div class="project_title">
                                                        <h4><a href="{{route('Products')}}">Food App Design</a></h4>
                                                    </div>
                                                    <div class="project_category">
                                                        <h4><a href="{{route('Products')}}">App Design</a></h4>
                                                    </div>
                                                    <div class="project_likes">
                                                        <a href="{{route('Products')}}"><i class="fa fa-heart-o" aria-hidden="true"></i> 1548</a>
                                                    </div>
                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="team_slider_wrapper">
                                    ...
                                    <div class="team_members_slider_content">
                                        <h5>(Founder)</h5>
                                        <h4><a href="{{route('Products')}}">Jhon Parker</a></h4>
                                        <p>People who already have strong trust relships.</p>
                                        <a href="{{route('Products')}}" class="btn btn-default">Contact</a>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="team_slider_wrapper">
                                    ...
                                    <div class="team_members_slider_content">
                                        <h5>(Trader)</h5>
                                        <h4><a href="{{route('Products')}}">Martina Colliys</a></h4>
                                        <p>People who already have strong trust relships.</p>
                                        <a href="{{route('Products')}}" class="btn btn-default">Contact</a>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="team_slider_wrapper">
                                    ...
                                    <div class="team_members_slider_content">
                                        <h5>(Manager)</h5>
                                        <h4><a href="{{route('Products')}}">Jessica Jackson</a></h4>
                                        <p>People who already have strong trust relships.</p>
                                        <a href="{{route('Products')}}" class="btn btn-default">Contact</a>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="team_slider_wrapper">
                                    ...
                                    <div class="team_members_slider_content">
                                        <h5>(Developer)</h5>
                                        <h4><a href="{{route('Products')}}">Kenneyth Deo</a></h4>
                                        <p>People who already have strong trust relships.</p>
                                        <a href="{{route('Products')}}" class="btn btn-default">Contact</a>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="team_slider_wrapper">
                                    ...
                                    <div class="team_members_slider_content">
                                        <h5>(core Team)</h5>
                                        <h4><a href="{{route('Products')}}">Dia Josaf</a></h4>
                                        <p>People who already have strong trust relships.</p>
                                        <a href="{{route('Products')}}" class="btn btn-default">Contact</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="pricing-table-default text-left">
                                ...
                                <div class="pricing-detail">
                                    ...
                                    <a href="{{route('Products')}}" class="btn btn-default">Get Started</a>
                                </div>
